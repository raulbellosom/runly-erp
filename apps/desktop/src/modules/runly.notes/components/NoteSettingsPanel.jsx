...
import {
  ConfirmDialog, TextField, CreatableComboboxField, CheckboxField,
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full sm:max-w-md p-0 gap-0">
        <SheetHeader className="px-5 pt-1 pb-4 border-b border-border shrink-0">
          <SheetTitle>Ajustes de nota</SheetTitle>
        </SheetHeader>

        <div className="flex-1 min-h-0 overflow-y-auto px-5 py-5 flex flex-col gap-6 text-sm">
          ...
          <div className="flex items-end gap-3">
            <Popover>
              <PopoverTrigger asChild>
                <button
                  className="w-11 h-11 shrink-0 rounded-xl border border-border bg-muted flex items-center justify-center hover:bg-muted/70 transition-colors"
          ...
          {/* ── Organizacion: carpeta + etiquetas ───────────────── */}
          ...
          {/* ── Apariencia: color + estilo de hoja ──────────────── */}
