    ...
    async extractLedgerStatementPage({ imageBase64, mimeType }) {
      return adapter.call({
        ...
        systemPrompt: [
          ...
          'Devuelve UNICAMENTE un objeto JSON valido con esta forma: {"rows": [{"fecha": "YYYY-MM-DD", "nombre": string, "referencia": string|null, "concepto": string|null, "numero": string|null, "deposito": number|null, "retiro": number|null}]}.',
