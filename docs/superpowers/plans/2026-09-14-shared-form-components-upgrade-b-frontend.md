...
- [x] **Step 1: Read the current `ComboboxField` in full**
...
- [x] **Step 1: Read the current `RelationSelectField` in full**
...
- [x] **Step 1: Read the current `CreatableComboboxField` in full**
...
- [x] **Step 1: Add the `react-pdf` dependency**
...
- [x] **Step 3: Fix internal imports in the 4 moved files**
...
- [x] **Step 4: Export from `packages/ui/src/index.js`**
...
- [x] **Step 5: Verify the package builds in isolation**
...
- [x] **Step 1: Write a failing test for the video kind**
...
- [x] **Step 2: Implement the video kind**
...
- [x] **Step 4: Make grouped view the default and rename its labels**
...
- [x] **Step 2: Implement — controller changes**
...
- [x] **Step 3: Implement — panel UI changes**
...
- [x] **Step 1: Read reference implementation**
